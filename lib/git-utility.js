...
class gitUtility {
  ...
  async init(){
    ...
    this.git.addConfig('user.email', 'upadhyay.yuvraj48@gmail.com', append = false, scope = 'global')
    this.git.addConfig('user.name', 'acc-github-repo', append = false, scope = 'global')
  }
