...
class gitUtility {
  ...
  async gitClone(repoURL, token) {
    try {
      var me = this;
      const USER = 'devesh48';
      let PASS = token?token:'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';
      // var git = simpleGit('gitSource', { binary: 'git' });
      const REPO = repoURL?repoURL:'github.com/devesh48/dynamicFilecommitRepo.git';
